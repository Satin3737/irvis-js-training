...
import {gulpServer} from "./gulp/tasks/gulp-server.js";
...
import {otfToTtf, ttfToWoff, woff} from "./gulp/tasks/gulp-fonts.js";
...
// task for fonts
const fonts = gulp.series(otfToTtf, ttfToWoff, woff);

// main tasks
const mainTasks = gulp.series(fonts, gulp.parallel(gulpCopy, gulpHtml, gulpScss, gulpJs, gulpImages)) ;

// create scenarios for tasks
const dev = gulp.series(gulpReset, mainTasks, gulp.parallel(watcher, gulpServer));
